...
namespace GameCraft
{
	public class SetMessageObject<ObjType, ObjValueType> : MessageObject<ObjType>
	{
		...
		public SetMessageObject (IList<ObjType> recList, string propertyName, ObjValueType objValue)
		{
			Receivers = recList;
			PropertyName = propertyName;
			ObjValue = objValue;
			Command = CommandObject.set;
		}
